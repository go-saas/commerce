...
func RegisterCategoryServiceHTTPServer(s *http.Server, srv CategoryServiceHTTPServer) {
	...
	r.GET("/v1/product/categories", _CategoryService_ListCategory1_HTTP_Handler(srv))
	r.GET("/v1/product/category/{id}", _CategoryService_GetCategory0_HTTP_Handler(srv))
	r.POST("/v1/product/category", _CategoryService_CreateCategory0_HTTP_Handler(srv))
	r.PATCH("/v1/product/category/{category.id}", _CategoryService_UpdateCategory0_HTTP_Handler(srv))
	r.PUT("/v1/product/category/{category.id}", _CategoryService_UpdateCategory1_HTTP_Handler(srv))
	r.DELETE("/v1/product/category/{id}", _CategoryService_DeleteCategory0_HTTP_Handler(srv))
}
...
func (c *CategoryServiceHTTPClientImpl) DeleteCategory(ctx context.Context, in *DeleteCategoryRequest, opts ...http.CallOption) (*DeleteCategoryReply, error) {
	...
	pattern := "/v1/product/category/{id}"
...
func (c *CategoryServiceHTTPClientImpl) UpdateCategory(ctx context.Context, in *UpdateCategoryRequest, opts ...http.CallOption) (*Category, error) {
	var out Category
	pattern := "/v1/product/category/{category.id}"
	path := binding.EncodeURL(pattern, in, false)
