...
var file_private_conf_conf_proto_rawDesc = []byte{
	...
	0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x01, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x74,
	0x73, 0x74, 0x72, 0x61, 0x70, 0x12, 0x1e, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x2a, 0x0a, 0x08, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74,
	...
	0x70, 0x70, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x67, 0x6f, 0x2d, 0x73, 0x61, 0x61, 0x73, 0x2f, 0x6b, 0x69, 0x74, 0x2d, 0x6c, 0x61, 0x79,
	0x6f, 0x75, 0x74, 0x2f, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x2f, 0x63, 0x6f, 0x6e, 0x66,
...
var file_private_conf_conf_proto_depIdxs = []int32{
	1, // 0: kratos.api.Bootstrap.data:type_name -> conf.Data
	2, // 1: kratos.api.Bootstrap.security:type_name -> conf.Security
	3, // 2: kratos.api.Bootstrap.services:type_name -> conf.Services
	4, // 3: kratos.api.Bootstrap.logging:type_name -> conf.Logging
	5, // 4: kratos.api.Bootstrap.tracing:type_name -> conf.Tracers
	6, // 5: kratos.api.Bootstrap.app:type_name -> conf.AppConfig
