...
// @ts-ignore
import { V1CreateTicketRequest } from '../models';
// @ts-ignore
import { V1DeleteTicketReply } from '../models';
// @ts-ignore
...
// @ts-ignore
import { V1UpdateTicketRequest } from '../models';
/**
...
export const TicketServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @param {V1CreateTicketRequest} body 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ticketServiceCreateTicket: async (body: V1CreateTicketRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('ticketServiceCreateTicket', 'body', body)
         ...
         * @throws {RequiredError}
         */
        ticketServiceDeleteTicket: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('ticketServiceDeleteTicket', 'id', id)
        ...
        ticketServiceListTicket2: async (body: V1ListTicketRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/ticket/ticket/list`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @param {V1UpdateTicketRequest} body 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ticketServiceUpdateTicket: async (ticketId: string, body: V1UpdateTicketRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ticketId' is not null or undefined
            assertParamExists('ticketServiceUpdateTicket', 'ticketId', ticketId)
            // verify required parameter 'body' is not null or undefined
            assertParamExists('ticketServiceUpdateTicket', 'body', body)
            const localVarPath = `/v1/ticketing/ticket/{ticket.id}`
         ...
         * @throws {RequiredError}
         */
        ticketServiceUpdateTicket2: async (ticketId: string, body: V1UpdateTicketRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ticketId' is not null or undefined
            assertParamExists('ticketServiceUpdateTicket2', 'ticketId', ticketId)
            // verify required parameter 'body' is not null or undefined
            assertParamExists('ticketServiceUpdateTicket2', 'body', body)
            const localVarPath = `/v1/ticketing/ticket/{ticket.id}`
                .replace(`{${"ticket.id"}}`, encodeURIComponent(String(ticketId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const TicketServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async ticketServiceCreateTicket(body: V1CreateTicketRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Ticket>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ticketServiceCreateTicket(body, options);
         ...
         * @throws {RequiredError}
         */
        async ticketServiceDeleteTicket(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1DeleteTicketReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ticketServiceDeleteTicket(id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ticketServiceListTicket(pageOffset?: number, pageSize?: number, search?: string, sort?: Array<string>, fields?: string, filterId$eq?: string, filterId$neq?: string, filterId$contains?: string, filterId$startsWith?: string, filterId$nstartsWith?: string, filterId$endsWith?: string, filterId$nendsWith?: string, filterId$in?: Array<string>, filterId$nin?: Array<string>, filterId$null?: boolean, filterId$nnull?: boolean, filterId$empty?: boolean, filterId$nempty?: boolean, filterId$like?: string, filterName$eq?: string, filterName$neq?: string, filterName$contains?: string, filterName$startsWith?: string, filterName$nstartsWith?: string, filterName$endsWith?: string, filterName$nendsWith?: string, filterName$in?: Array<string>, filterName$nin?: Array<string>, filterName$null?: boolean, filterName$nnull?: boolean, filterName$empty?: boolean, filterName$nempty?: boolean, filterName$like?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1ListTicketReply>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ticketServiceListTicket(pageOffset, pageSize, search, sort, fields, filterId$eq, filterId$neq, filterId$contains, filterId$startsWith, filterId$nstartsWith, filterId$endsWith, filterId$nendsWith, filterId$in, filterId$nin, filterId$null, filterId$nnull, filterId$empty, filterId$nempty, filterId$like, filterName$eq, filterName$neq, filterName$contains, filterName$startsWith, filterName$nstartsWith, filterName$endsWith, filterName$nendsWith, filterName$in, filterName$nin, filterName$null, filterName$nnull, filterName$empty, filterName$nempty, filterName$like, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ticketServiceUpdateTicket(ticketId: string, body: V1UpdateTicketRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Ticket>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ticketServiceUpdateTicket(ticketId, body, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async ticketServiceUpdateTicket2(ticketId: string, body: V1UpdateTicketRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<V1Ticket>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.ticketServiceUpdateTicket2(ticketId, body, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const TicketServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        ticketServiceCreateTicket(body: V1CreateTicketRequest, options?: any): AxiosPromise<V1Ticket> {
            return localVarFp.ticketServiceCreateTicket(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id 
         ...
         * @throws {RequiredError}
         */
        ticketServiceDeleteTicket(id: string, options?: any): AxiosPromise<V1DeleteTicketReply> {
            return localVarFp.ticketServiceDeleteTicket(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id 
         ...
         * @throws {RequiredError}
         */
        ticketServiceGetTicket(id: string, options?: any): AxiosPromise<V1Ticket> {
            return localVarFp.ticketServiceGetTicket(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} [pageOffset] 
         ...
         * @throws {RequiredError}
         */
        ticketServiceListTicket(pageOffset?: number, pageSize?: number, search?: string, sort?: Array<string>, fields?: string, filterId$eq?: string, filterId$neq?: string, filterId$contains?: string, filterId$startsWith?: string, filterId$nstartsWith?: string, filterId$endsWith?: string, filterId$nendsWith?: string, filterId$in?: Array<string>, filterId$nin?: Array<string>, filterId$null?: boolean, filterId$nnull?: boolean, filterId$empty?: boolean, filterId$nempty?: boolean, filterId$like?: string, filterName$eq?: string, filterName$neq?: string, filterName$contains?: string, filterName$startsWith?: string, filterName$nstartsWith?: string, filterName$endsWith?: string, filterName$nendsWith?: string, filterName$in?: Array<string>, filterName$nin?: Array<string>, filterName$null?: boolean, filterName$nnull?: boolean, filterName$empty?: boolean, filterName$nempty?: boolean, filterName$like?: string, options?: any): AxiosPromise<V1ListTicketReply> {
            return localVarFp.ticketServiceListTicket(pageOffset, pageSize, search, sort, fields, filterId$eq, filterId$neq, filterId$contains, filterId$startsWith, filterId$nstartsWith, filterId$endsWith, filterId$nendsWith, filterId$in, filterId$nin, filterId$null, filterId$nnull, filterId$empty, filterId$nempty, filterId$like, filterName$eq, filterName$neq, filterName$contains, filterName$startsWith, filterName$nstartsWith, filterName$endsWith, filterName$nendsWith, filterName$in, filterName$nin, filterName$null, filterName$nnull, filterName$empty, filterName$nempty, filterName$like, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {V1ListTicketRequest} body 
         ...
         * @throws {RequiredError}
         */
        ticketServiceListTicket2(body: V1ListTicketRequest, options?: any): AxiosPromise<V1ListTicketReply> {
            return localVarFp.ticketServiceListTicket2(body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} ticketId 
         ...
         * @throws {RequiredError}
         */
        ticketServiceUpdateTicket(ticketId: string, body: V1UpdateTicketRequest, options?: any): AxiosPromise<V1Ticket> {
            return localVarFp.ticketServiceUpdateTicket(ticketId, body, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} ticketId 
         ...
         * @throws {RequiredError}
         */
        ticketServiceUpdateTicket2(ticketId: string, body: V1UpdateTicketRequest, options?: any): AxiosPromise<V1Ticket> {
            return localVarFp.ticketServiceUpdateTicket2(ticketId, body, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for ticketServiceCreateTicket operation in TicketServiceApi.
 * @export
 * @interface TicketServiceApiTicketServiceCreateTicketRequest
 */
export interface TicketServiceApiTicketServiceCreateTicketRequest {
    /**
     * 
     * @type {V1CreateTicketRequest}
     * @memberof TicketServiceApiTicketServiceCreateTicket
     */
    readonly body: V1CreateTicketRequest
}

/**
 * Request parameters for ticketServiceDeleteTicket operation in TicketServiceApi.
 * @export
 * @interface TicketServiceApiTicketServiceDeleteTicketRequest
 */
export interface TicketServiceApiTicketServiceDeleteTicketRequest {
    /**
     * 
     * @type {string}
     * @memberof TicketServiceApiTicketServiceDeleteTicket
     */
    readonly id: string
}
...
/**
 * Request parameters for ticketServiceUpdateTicket operation in TicketServiceApi.
 * @export
 * @interface TicketServiceApiTicketServiceUpdateTicketRequest
 */
export interface TicketServiceApiTicketServiceUpdateTicketRequest {
    /**
     * 
     * @type {string}
     * @memberof TicketServiceApiTicketServiceUpdateTicket
     */
    readonly ticketId: string

    /**
     * 
     * @type {V1UpdateTicketRequest}
     * @memberof TicketServiceApiTicketServiceUpdateTicket
     */
    readonly body: V1UpdateTicketRequest
}

/**
 * Request parameters for ticketServiceUpdateTicket2 operation in TicketServiceApi.
 * @export
 * @interface TicketServiceApiTicketServiceUpdateTicket2Request
 */
export interface TicketServiceApiTicketServiceUpdateTicket2Request {
    /**
     * 
     * @type {string}
     * @memberof TicketServiceApiTicketServiceUpdateTicket2
     */
    readonly ticketId: string
...
export class TicketServiceApi extends BaseAPI {
    /**
     * 
     * @param {TicketServiceApiTicketServiceCreateTicketRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TicketServiceApi
     */
    public ticketServiceCreateTicket(requestParameters: TicketServiceApiTicketServiceCreateTicketRequest, options?: AxiosRequestConfig) {
        return TicketServiceApiFp(this.configuration).ticketServiceCreateTicket(requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }

    /**
     * 
     * @param {TicketServiceApiTicketServiceDeleteTicketRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TicketServiceApi
     */
    public ticketServiceDeleteTicket(requestParameters: TicketServiceApiTicketServiceDeleteTicketRequest, options?: AxiosRequestConfig) {
        return TicketServiceApiFp(this.configuration).ticketServiceDeleteTicket(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    /**
     * 
     * @param {TicketServiceApiTicketServiceUpdateTicketRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TicketServiceApi
     */
    public ticketServiceUpdateTicket(requestParameters: TicketServiceApiTicketServiceUpdateTicketRequest, options?: AxiosRequestConfig) {
        return TicketServiceApiFp(this.configuration).ticketServiceUpdateTicket(requestParameters.ticketId, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }

    /**
     * 
     * @param {TicketServiceApiTicketServiceUpdateTicket2Request} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TicketServiceApi
     */
    public ticketServiceUpdateTicket2(requestParameters: TicketServiceApiTicketServiceUpdateTicket2Request, options?: AxiosRequestConfig) {
        return TicketServiceApiFp(this.configuration).ticketServiceUpdateTicket2(requestParameters.ticketId, requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
}
