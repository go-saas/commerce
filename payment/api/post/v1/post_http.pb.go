...
const OperationPostServiceCreatePost = "/payment.post.v1.PostService/CreatePost"
const OperationPostServiceDeletePost = "/payment.post.v1.PostService/DeletePost"
const OperationPostServiceGetPost = "/payment.post.v1.PostService/GetPost"
const OperationPostServiceListPost = "/payment.post.v1.PostService/ListPost"
const OperationPostServiceUpdatePost = "/payment.post.v1.PostService/UpdatePost"
...
func RegisterPostServiceHTTPServer(s *http.Server, srv PostServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/payment/post/list", _PostService_ListPost0_HTTP_Handler(srv))
	r.GET("/v1/payment/posts", _PostService_ListPost1_HTTP_Handler(srv))
	r.GET("/v1/payment/post/{id}", _PostService_GetPost0_HTTP_Handler(srv))
	r.POST("/v1/payment/post", _PostService_CreatePost0_HTTP_Handler(srv))
	r.PATCH("/v1/payment/post/{post.id}", _PostService_UpdatePost0_HTTP_Handler(srv))
	r.PUT("/v1/payment/post/{post.id}", _PostService_UpdatePost1_HTTP_Handler(srv))
	r.DELETE("/v1/payment/post/{id}", _PostService_DeletePost0_HTTP_Handler(srv))
}
...
func (c *PostServiceHTTPClientImpl) UpdatePost(ctx context.Context, in *UpdatePostRequest, opts ...http.CallOption) (*Post, error) {
	var out Post
	pattern := "/v1/payment/post/{post.id}"
	path := binding.EncodeURL(pattern, in, false)
