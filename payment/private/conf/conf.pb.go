...
var file_payment_private_conf_conf_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf8, 0x01, 0x0a, 0x09, 0x42, 0x6f,
	...
	0x03, 0x61, 0x70, 0x70, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x2d, 0x73, 0x61, 0x61, 0x73, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65,
	0x72, 0x63, 0x65, 0x2f, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x70, 0x72, 0x69, 0x76,
...
var file_payment_private_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_payment_private_conf_conf_proto_depIdxs = []int32{
	1, // 0: payment.private.conf.Bootstrap.data:type_name -> conf.Data
	2, // 1: payment.private.conf.Bootstrap.security:type_name -> conf.Security
	3, // 2: payment.private.conf.Bootstrap.services:type_name -> conf.Services
	4, // 3: payment.private.conf.Bootstrap.logging:type_name -> conf.Logging
	5, // 4: payment.private.conf.Bootstrap.tracing:type_name -> conf.Tracers
	6, // 5: payment.private.conf.Bootstrap.app:type_name -> conf.AppConfig
