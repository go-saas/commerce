...
const OperationPostServiceCreatePost = "/order.post.v1.PostService/CreatePost"
const OperationPostServiceDeletePost = "/order.post.v1.PostService/DeletePost"
const OperationPostServiceGetPost = "/order.post.v1.PostService/GetPost"
const OperationPostServiceListPost = "/order.post.v1.PostService/ListPost"
const OperationPostServiceUpdatePost = "/order.post.v1.PostService/UpdatePost"
...
func RegisterPostServiceHTTPServer(s *http.Server, srv PostServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/order/post/list", _PostService_ListPost0_HTTP_Handler(srv))
	r.GET("/v1/order/posts", _PostService_ListPost1_HTTP_Handler(srv))
	r.GET("/v1/order/post/{id}", _PostService_GetPost0_HTTP_Handler(srv))
	r.POST("/v1/order/post", _PostService_CreatePost0_HTTP_Handler(srv))
	r.PATCH("/v1/order/post/{post.id}", _PostService_UpdatePost0_HTTP_Handler(srv))
	r.PUT("/v1/order/post/{post.id}", _PostService_UpdatePost1_HTTP_Handler(srv))
	r.DELETE("/v1/order/post/{id}", _PostService_DeletePost0_HTTP_Handler(srv))
}
